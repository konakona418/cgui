...
typedef long long int (* LocalEventHandler)(void* pSelf, CGUI_EventHandler* parent, HWND hwnd, UINT msg, WPARAM wParam,
                                            LPARAM lParam);
...
typedef struct WindowHandler {
    ...
    void (* onPaint)(
            CGUI_EventArgs args); // todo: note that this event should call the paint function of the component (gdi WM_PAINT).
...
typedef struct EventHandler {
    ...
    long long int
    (* handleEvent)(CGUI_EventHandler* self, CGUI_ComponentQuery query, UINT msg, WPARAM wParam, LPARAM lParam,
                    CGUI_ApplicationMessageCallback callback);
